...
final List<String Function(AppLocalizations)> _accessors =
    <String Function(AppLocalizations)>[
      ...
      (l) => l.searchFieldHint,
      (l) => l.searchNoResults,
      (l) => l.searchClearFilters,
      (l) => l.searchFilterAll,
      (l) => l.searchFilterPhotos,
      (l) => l.searchFilterVideos,
      (l) => l.searchFilterFavorites,
      (l) => l.mediaAddFavorite,
      (l) => l.mediaRemoveFavorite,
      (l) => l.mediaFavoriteFailed,
      (l) => l.mediaMoveToTrash,
      (l) => l.mediaMoveToTrashConfirm,
      (l) => l.mediaMovedToTrash,
      (l) => l.mediaTrashFailed,
      (l) => l.mediaTagsTitle,
      (l) => l.mediaTagsSave,
      (l) => l.mediaTagsNoneOnMedia,
      (l) => l.mediaTagsSearchLabel,
      (l) => l.mediaTagsNoMatches,
      (l) => l.tagAttributeThing,
      (l) => l.tagAttributePerson,
      (l) => l.tagAttributePlace,
      (l) => l.tagAttributeEvent,
      (l) => l.tagAttributeScene,
      (l) => l.tagAttributeActivity,
      (l) => l.tagAttributeSource,
      (l) => l.tagAttributeOthers,
      (l) => l.trashTitle,
      (l) => l.trashEmpty,
      (l) => l.trashRestore,
      (l) => l.trashRestored,
      (l) => l.trashRestoreFailed,
      (l) => l.settingsTitle,
      (l) => l.settingsTheme,
      ...
      (l) => l.logLevelWarning,
      (l) => l.logLevelError,
      (l) => l.notificationsTitle,
      (l) => l.notificationsEmpty,
      (l) => l.notificationsEmptyHint,
      (l) => l.notificationBackupCompleted,
      (l) => l.notificationBackupHadFailures,
      (l) => l.deepLinkTitle,
      (l) => l.deepLinkIntro,
...
const List<String> _keyNames = <String>[
  ...
  'searchFilterPhotos',
  'searchFilterVideos',
  'searchFilterFavorites',
  'mediaAddFavorite',
  'mediaRemoveFavorite',
  'mediaFavoriteFailed',
  'mediaMoveToTrash',
  'mediaMoveToTrashConfirm',
  'mediaMovedToTrash',
  'mediaTrashFailed',
  'mediaTagsTitle',
  'mediaTagsSave',
  'mediaTagsNoneOnMedia',
  'mediaTagsSearchLabel',
  'mediaTagsNoMatches',
  'tagAttributeThing',
  'tagAttributePerson',
  'tagAttributePlace',
  ...
  'notificationBackupCompleted',
  'notificationBackupHadFailures',
  'deepLinkTitle',
  'deepLinkIntro',
  'deepLinkOpenedWith',
